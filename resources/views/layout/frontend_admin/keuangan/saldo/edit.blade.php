  ...
  <div class="card-body">
    ...
    <div class="card-content p-2">
      ...
      <div class="modal-body">
        <div class="col-md-12">
          <form action="{{ route('finance_recapitulations.update', $finance_recapitulation->id) }}" method="POST"
                  ...
                  <div class="row">
                    <div class="col-md-12 col-12" style="margin-bottom: 5px">
                      <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('saldo') is-invalid @enderror" name="saldo"
                          value="{{ old('saldo',$finance_recapitulation->saldo) }}" placeholder="Masukkan Nominal Saldo"
