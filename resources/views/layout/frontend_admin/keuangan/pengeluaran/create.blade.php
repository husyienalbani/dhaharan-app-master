    ...
    <div class="card-body">
        ...
        <div class="card-content p-2">
            ...
            <div class="modal-body">
                <div class="col-md-12">
                    <form action="{{ route('finance_expenses.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-12" style="margin-bottom: 5px">
                                            <div class="mb-3">
                                                ...
                                                <input type="number"
                                                    class="form-control @error('expense_nominal') is-invalid @enderror"
                                                    name="expense_nominal" value="{{ old('expense_nominal') }}"
