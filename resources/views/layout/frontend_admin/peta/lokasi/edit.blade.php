...
<div class="card card-create mx-auto my-4" style="padding: 10px; width:100%;">
    <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card" style="padding: 10px;">
                                ...
                                <img src="/coverplace/{{$place->cover }}" class="card-img-top"
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select
                                                            ...
                                                            <option value="" selected disabled style="font-size: small">
                                                                Pilih Kategori Lokasi</option>
                                                            @foreach ($category as $item)
                                                            <option {{$item->id == $place->category_id ?
                                                                'selected' : ''}}
        ...
        var curLocation = [{{ $place->location }}];
